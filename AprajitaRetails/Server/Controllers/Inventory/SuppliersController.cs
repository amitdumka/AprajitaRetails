...
namespace AprajitaRetails.Server.Controllers.Inventory
{
    ...
    public class SuppliersController : ControllerBase
    {
        ...
        public SuppliersController(ARDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Supplier>> PostSupplier(Supplier supplier)
        {
          if (_context.Suppliers == null)
          {
              return Problem("Entity set 'ARDBContext.Suppliers'  is null.");
          }
            ...
            return CreatedAtAction("GetSupplier", new { id = supplier.SupplierName }, supplier);
        }
