//using System;
//using AprajitaRetails.Client.Pages.Apps.Inventory.Sale;
...
//                var flag = await Helper.SaveAsync<TItem>(ApiUrl, EntityModel, className, Id, IsEdit);
//                if (flag && !IsEdit)
//                {
//                    disable = true;
//                    //  EntityModel = entity;
